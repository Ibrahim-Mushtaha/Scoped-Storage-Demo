...
A simple application that I made by experimenting with Scoped Storage is mandatory for Android R.
...
<ul>
<li>Saving, loading, delete files from Internal Storage</li>
<li>Taking photos and saving them</li>
<li>Saving, loading, delete files from External Storage</li>
<li>Getting the uses-permissions</li>
</ul>
